...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            transformer_path = self.model_resolver.get_latest_transfermer_path()
            ...
            current_knn_imputer = load_object(file_path=self.data_transformation_artifact.transformation_object_path)
