...
import pandas as pd
import numpy as np
from music.entity.config_entity import TARGET_ENCODER_OBJECT_FILE_NAME, MODEL_FILE_NAME, TRANSFORMATION_OBJECT_FILE_NAME
...
class ModelResolver:
    ...
    def get_latest_transfermer_path(self):
        """
        ...
        try:
            ...
            return os.path.join(latest_dir,self.knn_imputer_dir_name,TRANSFORMATION_OBJECT_FILE_NAME)
        except Exception as e:
            raise MusicException(e, sys)
